...
var client = new Twitter({
  consumer_key: 'czcQ3XZglvl55P2g7hky9p1ca',
  consumer_secret: '8muF7HJDnRcBW1zzQGzAhMccsxQdMBnCeigGiyTbkVHePfRIhP',
  access_token_key: '556204911-VA1gmknhRlhmW0r2WZy9jVcjw1HRaeZfdWNbfcsm',
  access_token_secret: 'Db9fZ0RGu1kSaGnfLmiOXof6YdYVYIk0pJMcqRKBQwYji'
});
...
// twitterInterval = 1800;
twitterInterval = 2200;

// A list of things the robot will be interested in and want to favorite (and potentially respond to).
// These are case insensitive
var robotInterests = ['bots','cyborgs','artificial intelligence', 'wearables', 'AR', 'robots','singularity','skynet',];
...
var ignoredUsers = ['C3PO', 'thegrugq'];
...
var followUsers = false; // If true, allow bot to follow new users.
...
var stopwords = fs.readFileSync('theplague.txt').toString().split("\n");
