...
resource "aws_s3_bucket_object" "object" {
  ...
  <html>
  <head>
      <title>${local.project-prefix}</title>
  </head>
  <body>
      <main style="width:100vw;height:100vh; font-family:sans-serif;">
          <div id="page-1" style="cursor:pointer;">
              <h1>${local.client}m ${local.jobName} ${local.env}</h1>
          </div>
      </main>
  </body>
  </html>
...
# Create Policy for Cloudfront Placeholder
